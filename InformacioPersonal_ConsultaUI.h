...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->panel1->Size = System::Drawing::Size(416, 216);
			...
			this->label2->Size = System::Drawing::Size(408, 31);
			this->label2->TabIndex = 2;
			this->label2->Text = L"Consultar Informació Personal";
			// 
			// button1
			// 
			this->button1->ForeColor = System::Drawing::Color::Red;
			this->button1->Location = System::Drawing::Point(614, 440);
			...
			this->ClientSize = System::Drawing::Size(724, 484);

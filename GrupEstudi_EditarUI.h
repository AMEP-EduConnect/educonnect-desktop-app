...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->EditarGrupEstudi_Label->Location = System::Drawing::Point(374, 41);
			...
			this->EditarGrupEstudi_Label->Size = System::Drawing::Size(336, 41);
			...
			this->NomActual_TextBox->Font = (gcnew System::Drawing::Font(L"Inter", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->NomActual_TextBox->Location = System::Drawing::Point(41, 57);
			this->NomActual_TextBox->Margin = System::Windows::Forms::Padding(4);
			this->NomActual_TextBox->Name = L"NomActual_TextBox";
			this->NomActual_TextBox->Size = System::Drawing::Size(521, 32);
			...
			this->Nom_Label->Location = System::Drawing::Point(36, 30);
			this->Nom_Label->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->Nom_Label->Name = L"Nom_Label";
			this->Nom_Label->Size = System::Drawing::Size(138, 24);
			...
			this->Editar_Panel->Location = System::Drawing::Point(240, 170);
			this->Editar_Panel->Margin = System::Windows::Forms::Padding(4);
			this->Editar_Panel->Name = L"Editar_Panel";
			this->Editar_Panel->Size = System::Drawing::Size(605, 359);
			...
			this->noModificarButton->Location = System::Drawing::Point(40, 292);
			this->noModificarButton->Margin = System::Windows::Forms::Padding(4);
			this->noModificarButton->Name = L"noModificarButton";
			this->noModificarButton->Size = System::Drawing::Size(130, 43);
			...
			this->Edita_Button->Font = (gcnew System::Drawing::Font(L"Inter", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->Edita_Button->Location = System::Drawing::Point(432, 292);
			this->Edita_Button->Margin = System::Windows::Forms::Padding(4);
			this->Edita_Button->Name = L"Edita_Button";
			this->Edita_Button->Size = System::Drawing::Size(132, 43);
			...
			this->EditarDescripcio_TextBox->Font = (gcnew System::Drawing::Font(L"Inter", 11.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->EditarDescripcio_TextBox->Location = System::Drawing::Point(41, 148);
			...
			this->EditarDescripcio_TextBox->Size = System::Drawing::Size(522, 114);
			...
			this->Descripcio_Label->Location = System::Drawing::Point(36, 121);
			this->Descripcio_Label->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->Descripcio_Label->Name = L"Descripcio_Label";
			this->Descripcio_Label->Size = System::Drawing::Size(193, 24);
			...
			this->Cancelar_Button->Location = System::Drawing::Point(917, 597);
			this->Cancelar_Button->Margin = System::Windows::Forms::Padding(4);
			this->Cancelar_Button->Name = L"Cancelar_Button";
			this->Cancelar_Button->Size = System::Drawing::Size(119, 43);

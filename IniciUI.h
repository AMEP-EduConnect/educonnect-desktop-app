...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->pictureBox4->Location = System::Drawing::Point(78, 56);
			...
			this->label7->Location = System::Drawing::Point(104, 59);
			...
			this->label5->Location = System::Drawing::Point(-4, 10);
			this->label5->Margin = System::Windows::Forms::Padding(3, 0, 3, 24);
			this->label5->Name = L"label5";
			this->label5->Size = System::Drawing::Size(194, 19);
			this->label5->TabIndex = 11;
			this->label5->Text = L"Això sembla molt buit! :(";
			// 
			// pictureBox3
			// 
			...
			this->label6->Font = (gcnew System::Drawing::Font(L"Inter Light", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label6->Location = System::Drawing::Point(23, 138);
			this->label6->Name = L"label6";
			this->label6->Size = System::Drawing::Size(86, 19);
			this->label6->TabIndex = 4;
			this->label6->Text = L"Nom Grup";
			// 
			// Grup2
			// 
			...
			this->Grup2->Controls->Add(this->label6, 0, 1);
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Inter Light", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label1->Location = System::Drawing::Point(23, 138);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(86, 19);
			this->label1->TabIndex = 4;
			this->label1->Text = L"Nom Grup";
			// 
			// Grup3
			// 
			...
			this->Grup3->Controls->Add(this->label1, 0, 1);
			...
			this->ClientSize = System::Drawing::Size(1252, 774);

...
namespace CppCLRWinFormsProject {
    ...
    Void IniciUI::SetRecentGroups()
    {
        ...
        if (groups->Count == 3) {
            ...
            this->Grup1Initials->Text = initials;
            ...
            initials = extreureInicials(enumerator->Current->GetGroupName());
            this->Grup2Initials->Text = initials;
            ...
            initials = extreureInicials(enumerator->Current->GetGroupName());
            this->Grup3Initials->Text = initials;
    ...
    String^ IniciUI::extreureInicials(String^ text) {
        String^ initials = "";
        if (text->Contains(" ")) {
            ...
            // Igual para el caso sin espacios
            initials = text->Substring(0, 1)->ToUpper();  // Convierte a mayúscula si necesario
        }

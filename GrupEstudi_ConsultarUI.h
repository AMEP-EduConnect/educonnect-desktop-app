...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button_Cancelar->Location = System::Drawing::Point(728, 482);
			...
			this->button_Cancelar->Click += gcnew System::EventHandler(this, &GrupEstudi_ConsultarUI::testbutton_Cancelar);
			// 
			// GrupEstudi_ConsultarUI
			// 
